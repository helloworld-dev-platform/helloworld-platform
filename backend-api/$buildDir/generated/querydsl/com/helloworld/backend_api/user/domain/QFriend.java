...
public class QFriend extends EntityPathBase<Friend> {
    ...
    private static final long serialVersionUID = -1935590875L;
    ...
    public final QUser userA;

    public final QUser userB;
    ...
    public QFriend(Class<? extends Friend> type, PathMetadata metadata, PathInits inits) {
        ...
        this.userA = inits.isInitialized("userA") ? new QUser(forProperty("userA")) : null;
        this.userB = inits.isInitialized("userB") ? new QUser(forProperty("userB")) : null;
    }
