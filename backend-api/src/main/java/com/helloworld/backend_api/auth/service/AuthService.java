...
public class AuthService {
  ...
  public JwtTokenResponseDto reissueTokens(String refreshToken) {
    ...
    Optional<UserLevelTestResult> latestTestResult = findLatestTestResult(userId);
  ...
  private Optional<UserLevelTestResult> findLatestTestResult(Long userId) {
    return userLevelTestResultRepository.findFirstByUserIdOrderByCompletedAtDesc(userId);
  }
