...
@Getter
public class UserLeveltestResult extends BaseTimeEntity {
  ...
  @ManyToOne(fetch = FetchType.LAZY)
  @JoinColumn(name = "LEVEL_TEST_LEVEL_ID", nullable = false)
  private LevelTestLevel levelId;

  @Column(name = "COMPLETED_AT")
  private LocalDateTime completedAt;

  @Builder
  public UserLeveltestResult(Long id, LearningLanguage languageId, User user,
      LevelTestLevel levelId, LocalDateTime completedAt) {
    this.id = id;
