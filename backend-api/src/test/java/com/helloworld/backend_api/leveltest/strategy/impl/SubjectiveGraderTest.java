...
//         // given
//         LevelTestGradeRequest request = new LevelTestGradeRequest(" object ");
...
//         // given
//         LevelTestGradeRequest request = new LevelTestGradeRequest("class");
//         when(solutionRepository.findByProblemId(1L)).thenReturn(Optional.of(solution));
//
//         // when
//         GradingResult result = subjectiveGrader.grade(1L, request);
...
//         // given
//         LevelTestGradeRequest request = new LevelTestGradeRequest("anything");
...
//         // given
//         LevelTestGradeRequest request = new LevelTestGradeRequest(null);
//         when(solutionRepository.findByProblemId(1L)).thenReturn(Optional.of(solution));
//
//         // when
//         GradingResult result = subjectiveGrader.grade(1L, request);
